...
<div class="de">
  ...
  <div class="enq"> <form name="frmEnq" method="post" action="<?php echo SITEROOT;?>booking-form.html"><input name="packagecode" type="hidden" value="<?php echo $packagecode;?>" /><a href="javascript:void(0);" onclick="frmEnq.submit();" >Enquiry</a></form> </div>

  <!--enq-->

  <div class="pdf"> <form action="" method="post" name="frmPrint" target="_blank">

        <input name="id" type="hidden" value="<?php echo $id;?>" />

        <img src="<?php echo SITEROOT;?>im/pdf-icon.png" alt="Download PDF" title="Download PDF" border="0" onclick="frmPrint.action='<?php echo SITEROOT;?>generate.html'; frmPrint.submit();" style="cursor:pointer;" />

        <img src="<?php echo SITEROOT;?>im/printButton.png" alt="Print this Package" title="Print this Package" border="0" onclick="frmPrint.action='<?php echo SITEROOT;?>print-package.php'; frmPrint.submit();" style="cursor:pointer;" />
  ...
  <div class="dbyd">
    ...
    <div class="www">
      ...
      <div class="dbrf">
        ...
        <?php echo stripslashes($rasItinerary['description']);?>
